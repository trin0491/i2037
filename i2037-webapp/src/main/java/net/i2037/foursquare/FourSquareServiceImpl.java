...
public class FourSquareServiceImpl implements FourSquareService {
	...
	private static final String URL = "https://api.foursquare.com/v2/venues/{venueId}?client_id=MJTHR3UEY3DPQH3NTNFOVECMAB3AIZWFH3YUDOEXDPRED0HQ&client_secret=B1SLXUAG5SK05XND3NWB02DISYLKI2NWEYAJEED0302BWRDM&v=20131027";
	
	private RestTemplate fourSquareTemplate;
	
	@Override
	public Map<String, Object> getVenue(String venueId) {
		return fourSquareTemplate.getForObject(URL, Map.class, venueId);
	}

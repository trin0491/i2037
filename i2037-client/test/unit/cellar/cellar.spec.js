...
describe('i2037.cellar', function() {
  ...
  describe('ListWineCtrl', function(){
    ...
    it('should have a refresh method', function() {
      ...
      expect(params.Wine.query.calls.length).toEqual(1);
      expect(scope.refresh()).toBeUndefined();
      expect(params.Wine.query.calls.length).toEqual(2);       
    });
  });
    ...
    beforeEach(function() {
      ...
      inject(function($rootScope, $controller) {
        ...
        params = {
          ...
          $location: jasmine.createSpyObj('$location', ['path']), 
          wine: wine, 
          Grape: { query: function() { return grapes}}
        };
        spyOn(params.Grape, 'query').andCallThrough();

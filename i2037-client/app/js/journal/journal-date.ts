...
///<reference path="../common/resources/comments.ts" />

module i2037.journal {

  import ICommentResource = i2037.resources.ICommentResource;
  import IComment = i2037.resources.IComment;
  import Comment = i2037.resources.Comment;
